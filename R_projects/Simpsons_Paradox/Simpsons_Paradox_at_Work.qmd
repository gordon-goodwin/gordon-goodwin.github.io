...
-   The CPO is a staunch advocate of rewarding seniority with increased compensation opportunities.

-   The CPO launched a new compensation structure about a year ago that was designed to reflect this.

In order to determine whether the new compensation structure has been effective, the CPO wants to know if there is a **strong association between salary and seniority**.
...
We'll start by plotting the relationship between salary and seniority for *all* employees.

When we do so, it appears that employee compensation is **negatively** associated with years of seniority!
...
We can confirm this trend with a **linear regression model**:
...
**For employees assigned to the same department, higher salaries are *positively* related to greater seniority.**
...
A **multivariate regression model** confirms this:
...
Putting the pieces together, salary appears to vary negatively with seniority at the company-wide level because the *higher-seniority employees are concentrated in the lower-paying departments.*
...
The CPO was so impressed by our insights that he has a new project for us!

Now he wants us to analyze the relationship between employee **pre-hire sourcing** and **job satisfaction**.

-   Prior analyses found that employees sourced via referral performed better than those who applied traditionally.

-   Job Satisfaction is a critical KPI for the CPO, and the company routinely administers Pulse surveys to monitor it.
...
We'll start by visualizing the initial relationship between job satisfaction and pre-hire source.

At first, it appears that referred employees are **less likely** to rate their job satisfaction favorably!
...
We can confirm this trend by using a **simple logistic regression model**:

-   **In comparison to traditional applicants, referred employees are 64% as likely (36% less likely) to rate their jobs favorably**
...
-   Compared to the In-Office employees (our model reference group), Remote team members are over 12.5x more likely to view their jobs favorably!
...
-   **Office employees are less likely to be satisfied regardless of pre-hire source.**

-   **Referred employees are more likely to be Office-based.**

-   **Traditional Applicants are more likely to be Remote.**

-   ***Within*** ***each location type*****, referred employees are more likely to be satisfied.**
...
In sum, *referred employees appear to be less satisfied overall because they are heavily concentrated In-Office, and Office-based employees tend to be less satisfied than Remote teams regardless of pre-hire source.*

In other words, **location type acts as a confounding factor for the association between referral status and job favorability**. Within each work modality, referred employees tend to view their jobs more favorably than traditional applicants..
